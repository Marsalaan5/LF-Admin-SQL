// import modulesConfig from '../config/moduleConfig.js'
...
export function checkPermission(moduleName, action) {
  return (req, res, next) => {
    ...
    if (!user || !user.permissions) {
      return res.status(403).json({ message: "Forbidden: Permissions not found" });
    }
...
//           message: `Permission denied: Missing '${action}' on '${module}'`,
//         });
//       }
