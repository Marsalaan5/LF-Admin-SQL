...
//   return (
//     <nav className="navbar fixed-top navbar-expand-lg navbar-light" style={{ background: "pink" }}>
//       <div className="container-fluid d-flex justify-content-between align-items-center">
//         <div className="d-flex align-items-center gap-3">
//           <h4 className="mb-0">Admin</h4>

//           <div className="search-box d-flex align-items-center border rounded-pill px-3 py-1">
...
//         <div className="d-flex align-items-center gap-3">
//           <button className="btn btn-outline-secondary"><i className="fas fa-shopping-cart"></i></button>
//           <button className="btn btn-outline-secondary"><i className="fas fa-envelope"></i></button>
//           <button className="btn btn-outline-secondary"><i className="fas fa-bell"></i></button>

//           {isLoggedIn ? (
//             <div className="dropdown">
//               <button className="btn btn-outline-secondary d-flex align-items-center gap-2 dropdown-toggle" type="button" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
//                 <img src={userPlaceholder} alt="User" className="rounded-circle" width="35" height="35" />
...
//             </div>
//           ) : (
//             <button className="btn btn-secondary" onClick={handleSignIn} >SignIn</button>
//           )}
//         </div>
//       </div>
//     </nav>
...
function Navbar({ toggleSidebar }) {
  ...
  return (
    ...
    //       <img src={userr} alt="admin" className="rounded-circle" style={{ width: "40px", height: "40px", objectFit: "cover" }}/>
    //       <h4 className="mb-0 text-dark fw-bold">Admin</h4>
    //     </div>

    //     <div className="d-flex align-items-center gap-3">
    //       <button className="btn btn-outline-secondary" onClick={toggleSidebar}><i className="fas fa-bars"></i></button>
    ...
    <nav className="navbar fixed-top navbar-light" style={{ background: "pink" }}>
